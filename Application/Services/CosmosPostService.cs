...
{
    class CosmosPostService : ICosmosPostService
    {
        private readonly ICosmosPostRepository _postRepository;
        private readonly IMapper _mapper;
        //dodano nowy konstruktor
        // wstrzyknięto zaleznosc
        public CosmosPostService(ICosmosPostRepository postRepository, IMapper mapper) //ctor Imaper potrzebny do mapowania
        {
